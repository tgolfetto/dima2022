...
void main() {
  ...
  setUp(() {
    ...
    // Auth
    var mockAuth = nock("https://identitytoolkit.googleapis.com").post(
      ...
      ..reply(
        200,
        '{"kind":"identitytoolkit#VerifyPasswordResponse","localId":"$userId","email":"thomas@thomas.it","displayName":"","idToken":"$authToken","registered":true,"refreshToken":"APJWN8f-Ql1aF1UQsZmqEMDjmifcIApPt5TcOklkHETU8m_WrbqoooNV_oHpMwzdiYLCn0cyxGVpMfFYWuK5xIEQfzPEtkKm-Oqrz_qJyekVxMSxsBIUgS4e67eV-PMZZhKwPKof44VRVc9E5kgkJ8LIY4TDGZ-u5sp-nRBA5tzec-JCTUOLRiAE2LCS2cgclIuQX5mz_lIfk86ACzAQr0gc4SvZH7MqjQ","expiresIn":"3600"}',
      );
    // User
    var mockUser = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .get("/users/$userId.json?auth=$authToken")
      ..reply(200,
    ...
    var mockUserDelete = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .delete("/users/$userId.json?auth=$authToken")
      ..reply(200, '');
    var mockUserUpdate = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .put("/users/$userId.json?auth=$authToken")
      ..reply(200, '');

    // Products
    var mockProducts = nock("dima2022-491c4-default-rtdb.firebaseio.com")
    ...
    // Product
    var mockProduct = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .get(startsWith("/userFavorites/$userId/"))
      ..reply(200, '');

    // Requests
    var mockRequests = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .get(startsWith("/requests/$userId.json"))
      ..reply(200, '');
    var mockRequestsAdd = nock("dima2022-491c4-default-rtdb.firebaseio.com").post(
    ...
    var mockRequestsDelete = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .delete(startsWith("/requests/$userId.json"))
      ..reply(200, '');
    var mockRequestsUpdate = nock("dima2022-491c4-default-rtdb.firebaseio.com").put(
        startsWith("/requests/$userId.json"),
    ...
    var mockPosition = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .get(startsWith("/locations/man_area.json"))
      ..reply(200, positionArea);
    var mockPositionUpdate = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .patch(startsWith("/locations/man_area.json"), positionArea)
      ..reply(200, '');

    // Cart
    String cart = '{"-MEPxPT8F5BFAZbWokNc":{"id":"2023-01-23 19:33:37.349","imageUrl":"https://media.gucci.com/style/HEXE0E8E5_Center_0_0_1200x1200/1672418808/724623_XJEGU_7476_001_100_0000_Light-Felpa-con-cerniera-adidas-x-Gucci.jpg","price":19.99,"productId":"-MEPxPT8F5BFAZbWokNc","quantity":1,"title":"Felpa con cerniera adidas x Gucci"}}';
    var mockCart = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .get(startsWith("/carts/$userId.json"))
      ..reply(200, cart);
    var mockCartUpdate = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .put(startsWith("/carts/$userId.json"), cart)
      ..reply(200, '');

    // Orders
    var mockOrder = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .get(startsWith("/orders/$userId.json"))
      ..reply(200, '{"-NKxEVAjjTC7U2MXOgv4":{"amount":19.99,"dateTime":"2023-01-04T15:44:53.136","products":[{"id":"2023-01-04 15:44:06.443","imageUrl":"https://media.gucci.com/style/HEXE0E8E5_Center_0_0_1200x1200/1672418808/724623_XJEGU_7476_001_100_0000_Light-Felpa-con-cerniera-adidas-x-Gucci.jpg","price":19.99,"productId":"-MEPxPT8F5BFAZbWokNc","quantity":1,"title":"Felpa con cerniera adidas x Gucci"}]},"-NMidhlUFMmbnGlL_pTd":{"amount":19.99,"dateTime":"2023-01-26T16:15:38.705","products":[{"id":"2023-01-23 19:33:37.349","imageUrl":"https://media.gucci.com/style/HEXE0E8E5_Center_0_0_1200x1200/1672418808/724623_XJEGU_7476_001_100_0000_Light-Felpa-con-cerniera-adidas-x-Gucci.jpg","price":19.99,"productId":"-MEPxPT8F5BFAZbWokNc","quantity":1,"title":"Felpa con cerniera adidas x Gucci"}]}}');
    var mockCartAdd = nock("dima2022-491c4-default-rtdb.firebaseio.com")
        .post(startsWith("/carts/$userId.json"),
    '{"amount":19.99,"dateTime":"2023-01-26T16:15:38.705","products":[{"id":"2023-01-23 19:33:37.349","productId":"-MEPxPT8F5BFAZbWokNc","title":"Felpa con cerniera adidas x Gucci","quantity":1,"price":19.99,"imageUrl":"https://media.gucci.com/style/HEXE0E8E5_Center_0_0_1200x1200/1672418808/724623_XJEGU_7476_001_100_0000_Light-Felpa-con-cerniera-adidas-x-Gucci.jpg"}]}')
      ..reply(200, '{"name":"-NKxEVAjjTC7U2MXOgv4"}');
